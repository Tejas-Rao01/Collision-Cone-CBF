...
"""autogenerated by genpy from phasespace_msgs/Markers.msg. Do not edit."""
import codecs
import sys
...
class Markers(genpy.Message):
  _md5sum = "87fe27df7445224826bbc3363f7dd056"
  _type = "phasespace_msgs/Markers"
...
float32 cond"""
  ...
  _slot_types = ['std_msgs/Header','phasespace_msgs/Marker[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = phasespace_msgs.msg.Marker()
        _x = val1
        start = end
        end += 32
