...
(cl:defclass <Markers> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector phasespace_msgs-msg:Marker)
   :initform (cl:make-array 0 :element-type 'phasespace_msgs-msg:Marker :initial-element (cl:make-instance 'phasespace_msgs-msg:Marker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Markers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Markers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name phasespace_msgs-msg:<Markers> is deprecated: use phasespace_msgs-msg:Markers instead.")))
...
(cl:defmethod markers-val ((m <Markers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phasespace_msgs-msg:markers-val is deprecated.  Use phasespace_msgs-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Markers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'phasespace_msgs-msg:Marker))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Markers>)))
  ...
  (cl:format cl:nil "########################################~%# Messages~%########################################~%std_msgs/Header header~%Marker[] markers~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: phasespace_msgs/Marker~%########################################~%# Messages~%########################################~%uint32 id~%uint32 flags~%uint64 time~%float32 x~%float32 y~%float32 z~%float32 cond~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Markers)))
  "Returns full string definition for message of type 'Markers"
  (cl:format cl:nil "########################################~%# Messages~%########################################~%std_msgs/Header header~%Marker[] markers~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: phasespace_msgs/Marker~%########################################~%# Messages~%########################################~%uint32 id~%uint32 flags~%uint64 time~%float32 x~%float32 y~%float32 z~%float32 cond~%~%"))
